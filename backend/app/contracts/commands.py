...
class IncidentFollowupAction(StrEnum):
    ...
    RERUN_CEO_SHADOW = "RERUN_CEO_SHADOW"
    RERUN_BOARD_ADVISORY_ANALYSIS = "RERUN_BOARD_ADVISORY_ANALYSIS"
    RECOMPILE_CONTEXT = "RECOMPILE_CONTEXT"
    ...
    RESTORE_AND_RETRY_MAKER_CHECKER_REWORK = "RESTORE_AND_RETRY_MAKER_CHECKER_REWORK"
