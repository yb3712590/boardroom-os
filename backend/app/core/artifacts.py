...
def build_artifact_metadata(
    ...
    *,
    ...
    return {
        ...
        "storage_backend": artifact.get("storage_backend") or "LOCAL_FILE",
        "storage_object_key": artifact.get("storage_object_key"),
        "storage_delete_status": artifact.get("storage_delete_status") or "PRESENT",
        "storage_delete_error": artifact.get("storage_delete_error"),
