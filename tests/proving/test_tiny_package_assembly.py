...
def test_tiny_package_assembly_rejects_behavior_gaps_through_command_evidence(
    tmp_path: Path,
) -> None:
    from tests.proving.fixtures.tiny_package_assembly import (
    ...
    with pytest.raises(AssertionError, match="tiny evidence verification failed.*test-backend"):
