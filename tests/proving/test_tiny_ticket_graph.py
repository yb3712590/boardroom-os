...
def test_implementation_ticket_contract_fields_come_from_active_contracts() -> None:
    ...
    expected_acceptance_refs_by_ticket = {
        ...
        TICKET_DOCS_RUN_MANIFEST_ID: {"AC-TINY-ALL-RUN-AND-TEST-COMMANDS-VERIFIED"},
    }
    expected_source_surface_refs_by_ticket = {
        TICKET_BACKEND_API_ID: {"backend-api", "persistence", "run-manifest", "tests"},
        TICKET_FRONTEND_UI_ID: {"frontend-ui", "run-manifest", "tests"},
