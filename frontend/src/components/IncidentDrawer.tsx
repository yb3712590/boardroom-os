...
import type { IncidentDetailData } from '../api'
          ...
          >
            <header className="review-room-header">
              <div>
                ...
                <h2>{incident ? formatIncidentLabel(incident.incident_type) : 'Loading incident'}</h2>
                <p>{incident ? describeIncident(incident.incident_type) : 'Pulling the current incident payload.'}</p>
              </div>
