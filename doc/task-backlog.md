...
| 已完成 / 已收口 | 129 | 详细卡片与完成补记保存在 `task-backlog/done.md` |
| 当前仍未关闭 | 14 | 当前工作集保存在 `task-backlog/active.md` |
...
| 区域 | 任务范围 | 当前状态 | 默认看哪里 |
|------|----------|----------|------------|
| 当前主线 | `P2-DEC-002` 到 `P2-DEC-004` | 当前主线；`P2-DEC-001` 已完成，下一步继续收正 CEO/scheduler 与过程资产边界 | [task-backlog/active.md](task-backlog/active.md) |
