...
| 已完成 / 已收口 | 123 | 详细卡片与完成补记保存在 `task-backlog/done.md` |
...
| 区域 | 任务范围 | 当前状态 | 默认看哪里 |
|------|----------|----------|------------|
| 当前主线 | 无 | 暂无可直接开启任务；`P2-M7-005`、手动纳入的 `P2-RET-006`、`P2-MTG-011`、`P2-CEO-002` 与本轮手动纳入的 `P2-PRV-001/005/006` 已收口 | [task-backlog/active.md](task-backlog/active.md) |
