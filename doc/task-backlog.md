...
| 已完成 / 已收口 | 132 | 详细卡片与完成补记保存在 `task-backlog/done.md` |
...
| 区域 | 任务范围 | 当前状态 | 默认看哪里 |
|------|----------|----------|------------|
| 当前主线 | `P2-GOV-003` | 当前主线；`P2-DEC-001 / P2-DEC-002 / P2-DEC-003 / P2-DEC-004` 已完成，下一步进入文档/设计型角色产物契约 | [task-backlog/active.md](task-backlog/active.md) |
...
| 治理模板与文档链 | `P2-GOV-003` 到 `P2-GOV-006` | 当前主线 / 后续同批；顺序已接在 `P2-DEC-*` 之后 | [task-backlog/active.md](task-backlog/active.md) |
