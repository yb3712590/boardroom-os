...
| 文档 | `P2-DOC-001`、`P2-DOC-003`、`P2-DOC-005` | 进行中 | `P2-DOC-002`、`P2-DOC-004` 已完成；后续按真实变更继续同步 |
...
> 当前状态补记：`P2-DOC-002`、`P2-DOC-004` 已完成；这轮又把 `P2-UI-005` 到 `P2-UI-007` 真实关闭了，所以 `P2-D` 当前只剩文档任务。README、运维指南和 API 文档仍以后续真实对外变化为触发条件。
...
- `P2-DOC-*` 更适合作为发布前收口，不要反过来影响主链真相和现有验证链
