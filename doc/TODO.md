...
- 当前剩余风险是真相，不再写成“主链没打通”：minimal recovery seed 下，timeout / repeated-failure 这两条历史测试当前以“closeout 票完成”为准，workflow 级 dashboard completion 仍可能被额外 `GRAPH_HEALTH_CRITICAL` incident 挂住；这块后续要单独收 graph-health / workflow completion truth
