...
- 当前真正还没打开的主方向仍是 `P2-B`、`P2-C` 和 `C1` 条件批次，不是新平台系统建设
...
| M7 | 集成与交付口径收口 | 未开启 | 收窄为集成、文档和交付口径收口，不再承担“全部愿景落地” |
...
- 当前未关闭的部分：
  - `P1-CLN-002`：多租户 shared scope shape 仍在
  - `P1-CLN-003`：upload 导入入口与 session 存储仍在
