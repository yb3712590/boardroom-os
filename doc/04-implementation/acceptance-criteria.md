...
- [ ] AC-V2-CLOSEOUT-010（确定性哈希）— 分项闭合进度：
  ...
  - [x] V2-071C 已由 `test_process_audit_fact_chain.py` 证明 `checked_refs` 等 ProcessAudit 集合语义输入乱序后仍产生稳定 hash；V2-071D 仍待证明 GitVersionAudit 的 verification_runs / command_evidence_bindings 稳定性
...
- [ ] V2-071A ~ V2-071F 六个工作包全部 DONE（当前 V2-071A、V2-071B、V2-071C 已 DONE）
