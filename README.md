...
- 实现最薄的 React Boardroom UI，把 `dashboard / inbox / review room` 接起来
  - 当前前端视觉方向已单独固化在：
    - [doc/design/boardroom-ui-visual-concept.md](doc/design/boardroom-ui-visual-concept.md)
    - [doc/design/boardroom-ui-visual-spec.md](doc/design/boardroom-ui-visual-spec.md)
  - 首页默认参考 `workflow river + ticket 光点流转 + Board Gate 提醒`，不要回退到文字密集卡片后台
