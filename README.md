...
- 把 `source_code_delivery` 继续往下游收口：当前 BUILD 已切到真实源码交付，worktree 索引和 completion 读面也已接上；但真实 git worktree 分配/清理、非代码票 gate 还没补齐
...
- 2026-04-11 这轮已经补上项目工作区三分区、workspace-managed 代码票 hook、active worktree 索引，以及 completion 的源码/测试/git 摘要读面；旧的 artifact-path 代码票仍保持兼容
