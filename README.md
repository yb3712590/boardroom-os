...
- 在已落地的核心 employee lifecycle（`hire / replace / freeze / restore`）之上，继续补完整 staffing 治理：当前已覆盖 active 票的自动回收/围堵，但 restore / incident resolve 还不会自动恢复旧票，更多票型上的 staffing policy 也还没补齐
